...
const Hero = () => {
  return (
    <div>
        <div className='my-0 md:my-7 max-w-[1200px] h-auto mx-auto flex flex-col-reverse sm:flex-row 
                        justify-center align-center sm:mt-0' id='home'>
        
        <div className=' flex-col my-auto mx-auto'>
            <p className='md:text-5xl m-0 sm:text-4xl text-xl font-bold text-gray-200'>Hi! I'm Miguel Pineda</p>
            <div className='m-0'>
                <p className='md:text-3xl m-0 mt-2 sm:text-4xl text-xl font-bold text-gray-500'>and I'm working with...</p>
            </div>
        ...
        <div className='my-auto sm:flex sm:justify-center'>
          <img className=' w-[300px] sm:w-[500px] mx-auto h-auto' src={hero} alt="profile pic" />
        </div>
