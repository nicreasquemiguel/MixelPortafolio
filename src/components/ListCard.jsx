...
const ListCard = ({logo, size=60, title, desc, link }) => {
  return (
    <>
        <div className="grid hover:shadow-neon grid-cols-3 w-auto h-auto p-4 rounded-xl transform transition-all hover:-translate-y-2 duration-300 shadow-none d hover:shadow-2xl">

            <img className={'h-['+size+`px] md:h-[80px] grayscale col-span-3 md:col-span-1 col-start-2 md:col-start-1  md:row-span-2  object-cover `} src={logo} alt=""/>
